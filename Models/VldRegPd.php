...
class VldRegPd extends Model
{
    ...
    /**
     * public.vld_reg_pd → public.registrasi_peserta_didik (registrasi_id → registrasi_id).
     */
    ...
    /**
     * public.vld_reg_pd → ref.errortype (idtype → idtype).
     */
