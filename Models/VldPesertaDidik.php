...
class VldPesertaDidik extends Model
{
    use HasConnection;
    use SoftDeletes;
    ...
    /**
     * public.vld_peserta_didik → public.peserta_didik (peserta_didik_id → peserta_didik_id).
     */
    ...
    /**
     * public.vld_peserta_didik → ref.errortype (idtype → idtype).
     */
