...
class VldNonsekolah extends Model
{
    use HasConnection;
    use SoftDeletes;
    ...
    /**
     * public.vld_nonsekolah → public.lembaga_non_sekolah (lembaga_id → lembaga_id).
     */
    ...
    /**
     * public.vld_nonsekolah → ref.errortype (idtype → idtype).
     */
