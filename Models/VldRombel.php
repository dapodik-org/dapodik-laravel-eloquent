...
class VldRombel extends Model
{
    ...
    /**
     * public.vld_rombel → public.rombongan_belajar (rombongan_belajar_id → rombongan_belajar_id).
     */
    ...
    /**
     * public.vld_rombel → ref.errortype (idtype → idtype).
     */
