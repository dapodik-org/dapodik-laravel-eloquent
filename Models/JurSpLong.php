...
class JurSpLong extends Model
{
    ...
    protected $primaryKey = ['jurusan_sp_id', 'semester_id'];

    protected function casts(): array
    {
        return [
            'jumlah_pendaftar' => 'decimal',
            'last_sync' => 'datetime',
        ];
    }

    /**
     * public.jur_sp_long → public.jurusan_sp (jurusan_sp_id → jurusan_sp_id).
     */
